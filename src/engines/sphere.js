...
var Engine_Sphere=(function(){
  ...
  function updateTargets(){
    for(var i=0;i<points.length;i++){
      var p=points[i];
      var idx=p.index;
      var sinIdx=Math.sin(idx*0.001);
      var cosIdx=Math.cos(idx*idx*0.0001);
      p.targetx=Math.sin(idx*0.001+angle)*sinIdx*cfg.radius;
      p.targety=cosIdx*cfg.radius;
    }
  }
  ...
  var ENG={
    ...
    draw:function(){
      ...
      for(var i=0;i<points.length;i++){
        ...
        var sinIdx=sin(idx*0.001);
        var cosIdx=cos(idx*idx*0.0001);
        var homeX=sin(idx*0.001+angle)*sinIdx*cfg.radius;
        var homeY=cosIdx*cfg.radius;
